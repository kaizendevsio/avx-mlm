...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="page.Wallet.execSendToStockist();" class="btn btn-primary">
    ...
    <!--end::Modal-->
     ...
     <!--begin::Modal-->
    <div class="modal fade" id="m_modal_Wallet_update_qty" tabindex="-1" role="dialog" aria-labelledby="sendToStockist_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <h6><b>Product: </b><span id="m_modal_Wallet_update_productName">Product Name</span></h6>
                            <p><b>Description: </b><span id="m_modal_Wallet_update_productDesc">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus.</span></p>
                            <p><b>Quantity: </b> <span id="m_modal_Wallet_update_productQty">Loading..</span></p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="m_modal_Wallet_amount_to_send">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="m_modal_Wallet_message_text"></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="page.Wallet.execUpdateProductBalance();" class="btn btn-primary">
                         <i class="la la-send-o"></i> Send Product
                    </button>
                </div>
            </div>
        ...
        <header class="m-grid__item    m-header " data-minimize-offset="200" data-minimize-mobile-offset="200">
            <div class="m-container m-container--fluid m-container--full-height">
                <div class="m-stack m-stack--ver m-stack--desktop">
                    <!-- BEGIN: Brand -->
                    <div class="m-stack__item  m-stack__item--center m-brand  m-brand--skin-dark ">
                        <div class="m-stack m-stack--ver m-stack--general">
                            <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--middle m-stack__item  m-stack__item--center--center m-brand__logo">
                                <a href="index.html" class="m-brand__logo-wrapper">
                                    <img alt="" src="assets/demo/demo3/media/img/logo/logo.png" />
                                </a>
                            </div>
                            <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--middle m-brand__tools">
                    ...
                    <!-- END: Brand -->
                    <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--fluid m-header-head" id="m_header_nav">
                        ...
                        <div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general">
                            <div class="m-stack__item  m-stack__item--center m-topbar__nav-wrapper">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane" id="topbar_notifications_logs" role="tabpanel">
                                                                <div class="m-stack m-stack--ver m-stack--general" style="min-height: 180px;">
                                                                    <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--center m-stack__item  m-stack__item--center--middle">
                                                                        <span class="">
                                                                            All caught up!
                                                                            <br>
                                                                            No new logs.
        ...
        <footer class="m-grid__item		m-footer ">
            <div class="m-container m-container--fluid m-container--full-height m-page__container">
                <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                    <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--left m-stack__item  m-stack__item--center--middle m-stack__item  m-stack__item--center--last">
                    ...
                    <div class="m-stack__item  m-stack__item--center m-stack__item  m-stack__item--center--right m-stack__item  m-stack__item--center--middle m-stack__item  m-stack__item--center--first">
    ...
    <script>
        ...
        const Wallet = {
            ...
            initUpdateProductBalance: function (product_ID, product_Name, product_Desc, product_Qty) {
                ...
                page.vars.tmp_product_id = product_ID;
                document.getElementById('m_modal_Wallet_update_productName').innerHTML = product_Name;
                document.getElementById('m_modal_Wallet_update_productDesc').innerHTML = product_Desc;
                document.getElementById('m_modal_Wallet_update_productQty').innerHTML = product_Qty;

                $("#m_modal_Wallet_update_qty").modal();
            },
            execUpdateProductBalance: function () {
                var form = new FormData();
                form.append("product_id", page.vars.tmp_product_id);
                form.append("amount", document.getElementById('m_modal_Wallet_amount_to_send').value);
                form.append("remarks", document.getElementById('m_modal_Wallet_message_text').value);
                ...
                $.ajax(settings).done(function (response) {
                    response = JSON.parse(response);
                    if (response.status == '200') {
                        $("#m_modal_Wallet_update_qty").modal("hide");
